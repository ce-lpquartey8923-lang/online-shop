...
('dune-vase','Dune bud vase','ceramics',58,'A small, tactile silhouette that makes even one stem feel like enough.','https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?auto=format&fit=crop&w=1000&q=85','["Wheel-thrown porcelain","Each one is unique","3.5 in tall"]',null),
('linen-napkins','Everyday linen napkins','textiles',48,'Soft at the edges, durable at the table. A set of four in natural flax.','https://images.unsplash.com/photo-1583845112203-454c7ad4f2c3?auto=format&fit=crop&w=1000&q=85','["Set of four","100% linen","18 × 18 in"]',null),
('pebble-candle','Pebble beeswax candle','objects',28,'A hand-poured, unscented candle with a shape borrowed from the shoreline.','https://images.unsplash.com/photo-1603006905003-be475563bc59?auto=format&fit=crop&w=1000&q=85','["Pure beeswax","12 hour burn","Unscented"]',null),
('still-life','Still life print','objects',76,'A quiet archival print for a corner that needs a little more attention.','https://images.unsplash.com/photo-1577083552431-6e5fd01aa342?auto=format&fit=crop&w=1000&q=85','["Archival giclée print","12 × 16 in","Unframed"]',null),
('cedar-scoop','Cedar measuring scoop','woodwork',24,'Carved by hand from aromatic cedar, for flour, coffee, or whatever you keep close.','https://images.unsplash.com/photo-1610701596007-11502861dcfa?auto=format&fit=crop&w=1000&q=85','["Hand-carved cedar","1 tbsp capacity","Made in small batches"]',null)
